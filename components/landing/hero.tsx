    ...
    <section className="border-b border-zinc-900">
      ...
      >
        <div className="max-w-3xl">
          <p className="hero-label text-sm uppercase tracking-[0.2em] text-zinc-500">
            AI-assisted full-stack project
          </p>

          <h1 className="hero-title mt-4 text-5xl font-bold tracking-tight sm:text-6xl">
            CSS Odyssey
          </h1>

          <p className="hero-description mt-6 max-w-2xl text-lg text-zinc-300">
